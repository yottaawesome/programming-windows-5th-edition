...
I'm currently going through the projects one by one and fixing the compilation switches (which are generating warnings and errors), as well as retargeting and upgrading the solutions. This means old .dsw, .dsp, and .dep files are being removed. If you need these files, look at the earlier commits of this repository.
